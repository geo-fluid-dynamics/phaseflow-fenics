...
#danaila_natural_convection.run(mesh_M=20, time_step_size=1.e-3, output_dir='M20')
...
#newton_lid_driven_cavity.run(mesh_M=32, time_step_size=1., final_time=1.)

#newton_lid_driven_cavity.run(linearize=True, output_dir='output_linearized_nldc', mesh_M=32, time_step_size=1., final_time=1.)
