...
def stefan_problem(Ste = 1.,
    ...
    w, mesh = phaseflow.run(
        ...
        boundary_conditions = [
            ...
            {'subspace': 2, 'value_expression': str(theta_h), 'degree': 2, 'location_expression': "near(x[0],  0.)", 'method': "topological"},
            {'subspace': 2, 'value_expression': str(theta_c), 'degree': 2, 'location_expression': "near(x[0],  1.)", 'method': "topological"}],
        source_expression = ("0.", "0.", "0."),
...
def test_stefan_problem_solidify__nightly(Ste = 0.125,
    ...
    w, mesh = phaseflow.run(
        ...
        boundary_conditions = [
            {'subspace': 0, 'value_expression': "0.", 'degree': 3, 'location_expression': "near(x[0],  0.) | near(x[0],  1.)", 'method': "topological"},
            {'subspace': 2, 'value_expression': str(theta_c), 'degree': 2, 'location_expression': "near(x[0],  0.)", 'method': "topological"},
            {'subspace': 2, 'value_expression': str(theta_h), 'degree': 2, 'location_expression': "near(x[0],  1.)", 'method': "topological"}],
        source_expression = ("0.", "0.", "0."),
